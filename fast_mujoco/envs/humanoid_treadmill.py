...
from fast_mujoco.envs.mujoco_env import MujocoEnv
from gym.spaces import Box
import ipdb
from scipy.interpolate import interp1d
from fast_mujoco.envs.humanoid_utils import flip_action, flip_position, flip_velocity
import mujoco
...
class HumanoidTreadmillEnv(MujocoEnv, utils.EzPickle):
    ...
    def calc_reward(self, ref):
        ...
        # reward = orient_reward*.3 + joint_reward *.4 + pos_reward * .3
